...
param_grid = {
    ...
    #Parámetro de regularización, que controla el equilibrio entre
    # el ajuste a los datos y la penalización por complejidad del modelo. 
    # Valores más pequeños aumentan la regularización (menor sobreajuste) y 
    # valores grandes reducen la regularización (puede causar sobreajuste).
